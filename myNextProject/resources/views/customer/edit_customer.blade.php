...
<form role="form">
              ...
              <div class="row" style="padding: 0 15px;">
                <div class="box-footer">
                  <button type="" class="btn" style="float: right">Hủy</button>
                  <button type="" class="btn btn_update btn-primary" style="float: right; margin-right: 10px;">Update</button>
                </div>
              </div>
...
<script src="{{url('public/dist/js/custom_edit.js')}}"></script>
