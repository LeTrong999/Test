...
jQuery(document).ready(function($) {
    ...
    $('#address .icon_circle').on('click',function(){
        ...
        $(this).closest('.class_root').find('.flag_block').addClass('icon_circletop');
        $.getScript("./pubilc/dist/js/test.js");
    });
    //regex address
	...
	$('.btn_save').on('click', function(event) {
        ...
        customers.birthday =  $('input[name=txt_birthday]').val();
        console.log($('input[name=txt_birthday]').val());
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data.status == "ok"){
                    ...
                    toastr.error('Bạn thêm thất bại!!! Vui lòng kiểm tra lại');
                }
            },
    ...
    if(token!==null){
        ...
        $.ajax({
            url: 'http://crm.dev-altamedia.com/api/customer/status',
            type: 'GET',
            //headers : {'Authorization': token},
            success: function(data){
                data = $.parseJSON(data);
                ...
                $('select[name=txt_status]').append(html);
            },
