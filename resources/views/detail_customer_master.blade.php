...
<html>
<head>
  <base href="http://localhost/myNextProject/">
  <meta charset="utf-8">
  ...
  <link rel="stylesheet" href="{{url('public/dist/css/toastr.min.css')}}">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="@if($currentRoute == 'ticket.add') active  @endif"><a href="{{ route('ticket.add') }}"><i class="fa fa-circle-o"></i>Thêm Ticket</a></li>
            <li class="@if($currentRoute == 'ticket.list') active  @endif"><a href="{{ route('ticket.list') }}"><i class="fa fa-circle-o"></i>Danh sách ticket</a></li>
          </ul>
        </li>
...
<script src="{{url('public/dist/js/toastr.js')}}"></script>
