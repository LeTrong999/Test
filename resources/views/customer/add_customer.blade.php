...
<form role="form">
              <div class="box-body">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="txt_customer" >
                              <option selected disabled>---- Chọn kênh khách hàng ----</option>
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="txt_career">
                              <option selected disabled value="">Chọn nghành nghề</option>
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="txt_careerCom" >
                              <option disabled selected>---- Chọn nghành nghề ----</option>
                              <option>option 2</option>
                              <option>option 3</option>
                              <option>option 4</option>
                              <option>option 5</option>
                  ...
                  <div class="row" id="company">
                    <div class="row">
                      ...
                      <div class="col-xs-12">
                        ...
                        <div class="col-xs-2">
                          <span class="icon_circle"><i class="fa fa-plus-circle aaa"></i></span>
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="row" style="padding-left: 15px;display: block">
                    <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-10">
                      <div class="form-group">
                        ...
                        <input type="" class="form-control" id="charge" placeholder="">
                      </div>
                    </div>
                  </div>
